...
export const ABOUT_ME_TEXT = [
  ...
  "I'm currently looking for full-time software engineering opportunities starting in June/July 2023, and part-time SDE positions starting right now. If you're interested in working with me, feel free to reach out!",
];
